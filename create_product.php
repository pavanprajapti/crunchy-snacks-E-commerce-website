...
if(isset($_POST["create_product"])){
    ...
    $image_name1 = $_product_name."1.jpeg";
    $image_name2 = $_product_name."2.jpeg";
    $image_name3 = $_product_name."3.jpeg";
    $image_name4 = $_product_name."4.jpeg";

    move_uploaded_file($image1,"../assets/imges/".$image_name1);
    move_uploaded_file($image2,"../assets/imges/".$image_name2);
    move_uploaded_file($image3,"../assets/imges/".$image_name3);
    move_uploaded_file($image4,"../assets/imges/".$image_name4);
